...
async def fetch_completions_batch(model_name:str, queries:str, completion_func:typing.Callable) -> typing.Dict:
    tasks = [
...
def process_model_requests(model_name:str, completion_func:typing.Callable, path_name:str = "", format:str = "json") -> None:
    ...
    for annotator_num in [1, 2, 3]:
        ...
        predictions = asyncio.run(fetch_completions_batch(model_name, annotator_queries, completion_func))
